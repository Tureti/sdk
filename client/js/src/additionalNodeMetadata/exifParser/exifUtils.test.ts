...
describe('exif', () => {
    ...
    describe('getCaptureDateTimeString', () => {
        ...
        it('should return for pre-epoch dates (before 1970)', () => {
            const mockPreEpoch = {
                DateTimeOriginal: {
                    id: 36867,
            ...
            expect(value).toBe('1892-10-06T14:56:16.000Z');
        });
    });
    describe('getCaptureDateTime', () => {
        ...
        it('should return for pre-epoch dates (before 1970)', () => {
            ...
            expect(date.getTime()).toBe(new Date('1892-10-06T14:56:16').getTime());
        });
