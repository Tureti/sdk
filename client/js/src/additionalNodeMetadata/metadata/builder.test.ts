...
import { buildAdditionalNodeMetadata } from './builder';

describe('buildAdditionalNodeMetadata', () => {
    it('should build metadata from mediaInfo when no EXIF data', () => {
        const result = buildAdditionalNodeMetadata(undefined, {
            width: 1920,
            height: 1080,
            duration: 120,
        });
    ...
    it('should extract dimensions from EXIF when available', () => {
        ...
        const result = buildAdditionalNodeMetadata(exifInfo);
    ...
    it('should skip malformed SubjectArea without aborting metadata build', () => {
        const exifInfo: ExpandedTags = {
            exif: {
                Model: { value: ['iPhone 12'] },
                SubjectArea: { value: [] },
    ...
    it('should combine EXIF dimensions with mediaInfo duration', () => {
        ...
        const result = buildAdditionalNodeMetadata(exifInfo, { duration: 60 });
