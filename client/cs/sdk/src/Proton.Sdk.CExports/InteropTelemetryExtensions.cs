...
{
    public static InteropTelemetry? ToTelemetry(this SessionTelemetry telemetry, nint bindingsHandle)
    {
    ...
    private static LoggerFactory? GetLoggerFactory(SessionTelemetry telemetry, nint bindingsHandle)
    {
